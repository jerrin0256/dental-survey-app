...
// Behind Render/nginx/proxies so rate limits and req.ip use the real client
...
// Routes (single mount: clients must use /api/... — matches frontend api.js baseURL)
...
app.get('/', (req, res) => res.json({
  ...
  api: 'Use POST /api/send-otp and other routes under /api',
}));
